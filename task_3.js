...
for (let i = 1111; i <= 6666; i++) {
  let str = String(i)
  if (!str.includes('7') || !str.includes('8') || !str.includes('9') || !str.includes('0')) {
    list.push(i)
  }
}
...
function askUser() {
  c_input = Math.floor(Math.random(list.length))

  // task_ 3 hint: 3
  // How can i know which options are more favorable when i cant check them
